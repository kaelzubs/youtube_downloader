...
def add_security_headers(resp):
    ...
    resp.headers['Content-Security-Policy']="connect-src http://mp4us.live; script-src 'self' https://mp4us.live 'nonce-TWFuT2ZUaGVZZWFyMjAyMg==' 'strict-dynamic'; object-src https://mp4us.live d12vn54927k41s.cloudfront.net"
    return resp
############################################################################################
