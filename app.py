...
def add_security_headers(resp):
    ...
    resp.headers['Content-Security-Policy']="connect-src https://mp4us.live; script-src 'nonce-c780e10af33d990aed63225b26934f9a0c4099930b1e3ff1590eec245e4dfad5' 'strict-dynamic' 'unsafe-inline'; object-src 'none'; base-uri 'self'; require-trusted-types-for 'script'"
    return resp
############################################################################################
