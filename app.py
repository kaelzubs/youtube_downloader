...
def add_security_headers(resp):
    resp.headers['Content-Security-Policy']="default-src mp4us.live *.mp4us.live 'unsafe-inline'; img-src * data:; script-src-elem * data: 'unsafe-inline'; style-src-elem * data:; object-src 'none'; media-src * data:; font-src * data:; frame-src * data:;"
    return resp
############################################################################################
