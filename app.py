...
def add_security_headers(resp):
    resp.headers['Content-Security-Policy']="default-src * 'unsafe-inline'; img-src * data:; script-src *; style-src-elem * data:; object-src 'none'; media-src * data:; font-src * data:; frame-src * data:; connect-src * data:;"
    return resp
############################################################################################
