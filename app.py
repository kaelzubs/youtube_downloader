...
def add_security_headers(resp):
    ...
    resp.headers['Content-Security-Policy']="connect-src http://mp4us.live; script-src https://mp4us.live 'nonce-TWFuT2ZUaGVZZWFyMjAyMg==' 'strict-dynamic' 'unsafe-inline' https:; object-src 'none'; base-uri 'self'; require-trusted-types-for 'script'"
    return resp
############################################################################################
