...
def add_security_headers(resp):
    resp.headers['Content-Security-Policy']="default-src mp4us.live 'unsafe-inline' https:; img-src * data:; script-src-elem *.google.com *.doubleclick.net *.googleadservices.net *.googlesyndication.com *.googletagmanager.com cdn.jsdelivr.net d12vn54927k41s.cloudfront.net 'unsafe-inline'; style-src-elem * data:; object-src 'none'; media-src * data:; font-src * data:; frame-src * data:; connect-src * data:;"
    return resp
############################################################################################
