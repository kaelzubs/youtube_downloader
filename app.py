...
def add_security_headers(resp):
    resp.headers['Content-Security-Policy']="script-src 'sha256-DLyDZuhvYpHNsGfMqcG86eDCVvq5cc1nYwl4BqH5jBc=' 'unsafe-inline' 'self'; connect-src * data: blob: filesystem:; style-src 'self' data: 'unsafe-inline'; img-src 'self' data:; frame-src 'self' data:; font-src 'self' data:; media-src * data: blob: filesystem:; object-src 'none'; base-uri 'self'; require-trusted-types-for 'script'"
    return resp
############################################################################################
